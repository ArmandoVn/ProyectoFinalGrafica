...
#define MAX_FRAMES 9 // Define el numero maximo de frames.
int i_max_steps = 60; // Define la cantidad maxima de cuadros que puedo utilizar.
int i_curr_steps = 0;
typedef struct _frame // Estructura para guardar la variable que deseo animar
{
...
void saveFrame(void)
{
	...
	KeyFrame[FrameIndex].giraCabeza= giraCabeza;
	KeyFrame[FrameIndex].movVertical = movVertical;
...
void interpolation(void)
{
	...
	giraCabezaInc = (KeyFrame[playIndex + 1].giraCabeza - KeyFrame[playIndex].giraCabeza) / i_max_steps;
	movVerticalInc = (KeyFrame[playIndex + 1].movVertical - KeyFrame[playIndex].movVertical) / i_max_steps;
}
...
void animate(void)
{
	if (play)
	{
		...
		else
		{
			...
			giraCabeza += giraCabezaInc;
			movVertical += movVerticalInc;
...
int main()
{
	...
	for (int i = 0; i < MAX_FRAMES; i++)
	{
		...
		KeyFrame[i].giraCabeza = 0;
		KeyFrame[i].movVertical = 0;
	}
	...
	//KeyFrame[1].posY = 8.0f;
	//KeyFrame[1].posZ = 4.0f;
	//KeyFrame[1].rotRodIzq = 10.0f;
	//KeyFrame[1].giroMonito = 5.0f;
	//KeyFrame[1].movBrazoDer = 9.0f;
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		model = glm::translate(model, glm::vec3(posX, posY + movVertical, posZ));
		...
		//Cabeza
		model = glm::translate(tmp, glm::vec3(0.0f, -1.0f, 0.0f));
		model = glm::rotate(model, glm::radians(giraCabeza), glm::vec3(0.0f, 1.0f, 0.0));
